...
-- Create custom types
CREATE TYPE product_tier AS ENUM ('standard', 'premium', 'ultimate');
CREATE TYPE product_category AS ENUM ('golf_cart', 'utility', 'commercial', 'addon');
CREATE TYPE sale_type AS ENUM ('immediate', 'enquiry', 'both');
CREATE TYPE order_status AS ENUM ('pending', 'paid', 'processing', 'shipped', 'delivered', 'cancelled');
CREATE TYPE enquiry_type AS ENUM ('custom_cart', 'hire', 'general');
CREATE TYPE enquiry_status AS ENUM ('new', 'contacted', 'quoted', 'converted', 'closed');
CREATE TYPE chat_role AS ENUM ('user', 'assistant', 'agent');
...
CREATE INDEX idx_knowledge_base_embedding ON product_knowledge_base USING ivfflat (embedding vector_cosine_ops);
