...
export default function AccountCreationPrompt({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error: signUpError } = await signUp(customerEmail, password, customerName)
        ...
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-6 border-2 border-green-200">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="refined-title text-xl font-bold text-green-900 mb-2">
                Account Created Successfully!
              </h3>
              <p className="refined-body text-green-800 mb-4">
                We've sent a confirmation email to <strong>{customerEmail}</strong>.
                Please check your inbox and click the confirmation link to activate your account.
              </p>
              <div className="bg-white/50 rounded-sm p-4 border border-green-200">
                ...
                <ul className="refined-body text-sm text-green-800 space-y-1">
                  ...
                  <li>• Sign in to track your bookings and orders</li>
                </ul>
              </div>
            </div>
          </div>
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="mt-8"
      >
        <div className="bg-gradient-to-br from-rose-50 to-orange-50 rounded-lg p-6 border-2 border-rose-200 relative">
          {/* Dismiss Button */}
          <button
          ...
          <div className="mb-6">
            ...
            <p className="refined-body text-zinc-600">
              Save your information for faster checkout next time and track all your bookings in one place.
            </p>
          </div>

          {/* Benefits */}
          <div className="bg-white/60 rounded-sm p-4 mb-6 border border-rose-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              <div className="flex items-start gap-2">
                ...
                <span className="refined-body text-sm text-zinc-700">Track all your bookings</span>
              </div>
              <div className="flex items-start gap-2">
                <Check className="w-4 h-4 text-rose-600 mt-0.5 flex-shrink-0" />
          ...
          <div className="bg-white rounded-sm p-4 mb-6 border border-zinc-200">
